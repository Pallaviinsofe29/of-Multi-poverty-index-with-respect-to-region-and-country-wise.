...
model.knn=knn3(y~ .,train_data,k=1)
...
```{r}
library(randomForest)
model.rf=randomForest(y~ .,smoter_dataa,mtry=10,ntree=1500)
importance(model.rf)
varImpPlot(model.rf)
...
#KNN model with pca
```{r}
model.knn=knn3(y~ .,train_datanew1,k=1)
